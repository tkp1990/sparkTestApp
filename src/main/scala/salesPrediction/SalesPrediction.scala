...
object SalesPrediction extends Serializable {
  ...
  def main(args:Array[String]) = {
    ...
    logger.info(s"Starting up Sales Prediction Test")

    val conf = new SparkConf()
      .setAppName("Sales Prediction Test")
      .setMaster("local[*]");
    ...
    val data = loadTrainingData(sqlContext, url+"SalesPrediction/train.csv")
    val Array(testRaw, testData) = loadKaggleTestData(sqlContext, url+"SalesPrediction/test.csv")
